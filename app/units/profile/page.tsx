...
export default async function UnitProfilePage(props: any) {
  ...
  return (
    <div className="unit-profile-layout" style={{ display: "flex", height: "calc(100vh - 49px)", background: "var(--hbr-bg)", overflow: "hidden" }}>

      {/* LEFT — Full height character art */}
      <div className="unit-profile-art" style={{ width: 320, flexShrink: 0, position: "relative", background: "var(--hbr-surface)", borderRight: "0.5px solid var(--hbr-border)", overflow: "hidden" }}>
      ...
      <div className="unit-profile-content" style={{ flex: 1, overflowY: "auto", padding: "24px 28px" }}>
